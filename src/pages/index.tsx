  ...
  return (
    <div className="max-w-full">
      ...
      <header className="bg-header text-white flex justify-center items-center px-4 h-[80vh] w-full">
        ...
        <section className="h-full w-full md:max-w-[40vw] bg-black md:bg-transparent bg-opacity-70 rounded-lg px-8 flex flex-col justify-center text-center">
          <h1 className="font-bold text-2xl my-4 text-green-600 md:text-green-900">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4 w-full mx-auto mt-6 px-2">
          ...
          <div className="flex justify-center">
            <Image
              ...
              height={100}
              quality={100}
              className="w-3/4 h-auto transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-gray-700/50"
            />
          </div>
