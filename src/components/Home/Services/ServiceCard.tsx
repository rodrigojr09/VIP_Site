export default function ServiceCard({
	...
	return (
		<div className="w-[100%] h-full rounded-3xl bg-gradient-to-b from-gray-50 to-gray-100 hover:shadow-2xl hover:shadow-gray-500 hover:-translate-y-3 transition-all duration-300 ease-in-out flex flex-col overflow-hidden">
			{/* Seção Superior com Gradiente e Título */}
			<div className="h-32 flex items-center justify-center bg-gradient-to-r from-[#06622b] via-[#0fc658] to-[#06622b] relative">
				{/* Título */}
